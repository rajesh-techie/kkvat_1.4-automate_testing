...
import com.kkvat.automation.security.CustomUserDetailsService;
import com.kkvat.automation.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Test Manager and Admin
                        .requestMatchers("/users/**", "/groups/**").hasAnyRole("ADMIN", "TEST_MANAGER")
